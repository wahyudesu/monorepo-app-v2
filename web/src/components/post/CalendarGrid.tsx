                        ...
                        <div className="p-2.5">
                          <div className="flex items-center justify-between mb-1.5">
                            ...
                            <Badge
                              ...
                              className="pointer-events-none h-5 rounded-sm px-1.5 text-[9px] capitalize"
                            >
                              {ev.status}
                            </Badge>
                          </div>
                          <h4 className="font-display text-xs font-semibold mb-1 line-clamp-2">{ev.title}</h4>
                          {ev.time && (
        ...
        {cells.map((cell, i) => {
          ...
          return (
            <div
              key={i}
              className={cn(
                "min-h-[160px] border-b border-r border-border/30 p-2 transition-colors",
