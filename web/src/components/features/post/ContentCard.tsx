...
const statusBadgeStyles: Record<string, { bg: string; text: string }> = {
  published: {
    bg: "var(--badge-published)",
    text: "var(--badge-published-foreground)",
  },
  ...
  pending: {
    ...
    text: "var(--badge-pending-foreground)",
  },
};
...
export function ContentCard({
  ...
  return (
    <Card
      className={cn(
        "group/card p-2 cursor-pointer transition-all hover:shadow-md overflow-hidden",
        isSm && "text-xs",
        className,
      )}
      onClick={onClick}
