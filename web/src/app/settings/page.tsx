...
import { Users, Puzzle, User, Settings, Zap } from "lucide-react";
...
const tabs = [
  ...
  { id: "preferences", label: "Preferences", icon: Settings, title: "Preferences", description: "Customize your app experience" },
] as const;
...
function AccountTab() {
    ...
    const hasChanges = fullName !== originalFullName || jobTitle !== originalJobTitle;
    ...
    return (
      ...
      <Card className="border-destructive/30">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-display font-semibold text-sm text-destructive">Danger Zone</p>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-muted-foreground bg-muted px-1.5 py-0.5 rounded">{connectedPlatforms.length}</span>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-muted-foreground bg-muted px-1.5 py-0.5 rounded">{availablePlatforms.length}</span>
          </div>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <div className="space-y-4">
      <Card className="border-border/50">
        <CardContent className="p-4 space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-display font-semibold text-sm">Calendar Settings</p>
              <p className="text-xs text-muted-foreground">Customize your calendar view preferences.</p>
            </div>
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-4">
      <div className="text-center">
        <h1 className="font-display text-xl font-bold tracking-tight">{activeTabData?.title || "Settings"}</h1>
        <p className="text-xs text-muted-foreground">{activeTabData?.description || "Manage your settings"}</p>
      </div>
