...
} from '@/lib/animate-ui/primitives/effects/highlight';
import { getStrictContext } from '@/lib/get-strict-context';
import { useControlledState } from '@/hooks/use-controlled-state';
import {
  AutoHeight,
  type AutoHeightProps,
} from '@/lib/animate-ui/primitives/effects/auto-height';
...
type TabsHighlightProps = Omit<HighlightProps, 'controlledItems' | 'value' | 'mode'>;
...
function TabsPanels(props: TabsPanelsProps) {
  ...
  if (isAutoMode(props)) {
    const { children, transition, className, style } = props;
